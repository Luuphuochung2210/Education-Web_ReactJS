            ...
            <div className="blog-details-page-content">
              <div className="single-blog-inner">
                ...
                <div className="details">
                  ...
                  <p>
                    Lorem ipsum dolor sit amet, elitr, sed diam nonumy eirmod
                  ...
                  <div className="thumb mb-4">
                    <img
                      src={publicUrl + "assets/img/blog/single.png"}
                      alt="img"
                    />
                  </div>
                  ...
                  <ul className="single-list-wrap">
                    <li className="single-list-inner style-check">
                      <i className="fa fa-check" /> Stet clita kasd gubergren,
                      no sea takimata sanctus
                    </li>
                    <li className="single-list-inner style-check">
                      <i className="fa fa-check" /> Ligula cur maecenas no sea
                      takimata
                    </li>
                    <li className="single-list-inner style-check">
              ...
              <div className="blog-comment">
                ...
                <div className="media">
                  <a href="#">
                    <img
                      src={publicUrl + "assets/img/team/1.png"}
                      alt="comment"
                    />
                  </a>
                ...
                <div className="media nesting">
                  <a href="#">
                    <img
                      src={publicUrl + "assets/img/team/2.png"}
                      alt="comment"
                    />
                  </a>
                  <div className="media-body">
                    ...
                    <p>
                      Proin ac quam et lectus vestibulum blandit. Nunc maximus
                      nibh at placerat tincidunt. Nam sem lacus
                    </p>
                    <a href="#">REPLY</a>
                  </div>
                </div>
                <div className="media border-0">
                  <a href="#">
                    <img
                      src={publicUrl + "assets/img/team/3.png"}
                      alt="comment"
                    />
                  </a>
                  <div className="media-body">
